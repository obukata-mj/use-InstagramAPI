...
const embedInstagram = () => {
  document.querySelector('#instagram').insertAdjacentHTML('beforeend', '<div class="embed-instagram"></div>')
  ...
  Object.entries(instagramPostData.media).forEach(instaItems => {
    instaItems[1].forEach(eachItem => {
      ...
      if(eachItem.media_url !== null){
        ...
        document.querySelector('#instagram .embed-instagram').insertAdjacentHTML('beforeend', `
